      ...
      <div id="card">
        <div id="card-content">
          ...
          <form method="post" class="form" action="process_register.php">
            ...
            <input maxlength="45" class="form-content" type="text" id="fname" name="fname"
              placeholder="Enter first name">

            <div class="form-border"></div>

            <label for="lname" style="padding-top:22px">&nbsp;Last Name:</label>
            <input required maxlength="45" class="form-content" type="text" id="lname" name="lname"
            ...
            <input required class="form-content" type="password" id="pwd_confirm" name="pwd_confirm"
